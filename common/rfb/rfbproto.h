...
typedef struct _rfbWarnEventHeader {
  CARD32 infoLength;         /* length of remaining fields (not counting infoLength) */
  CARD32 infoKind;           /* kind of the info */
} rfbWarnEventHeader;

typedef struct _rfbWarnEventTimed {
